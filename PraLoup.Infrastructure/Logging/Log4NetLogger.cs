...
namespace PraLoup.Infrastructure.Logging
{
    public class Log4NetLogger : ILogger
    {
        ...
        public void Error(string message, Exception e)
        {
            ...
            {
                _logger.Error(AddDebugInfo(message + "[" + e + "]"));
            }
        }
        ...
        {
            this.Debug(string.Format(message, objs));
        }

        public void Error(string message, params object[] objs)
        {
            this.Error(string.Format(message, objs));
        }

        public void Info(string message, params object[] objs)
        {
            this.Info(string.Format(message, objs));
        }

        public void Warn(string message, params object[] objs)
        {
            this.Warn(string.Format(message, objs));
        }
    }
}