        ...
        public void IsFriend_Success()
        {
            using (var Scope = new SQLiteDatabaseScope<PraLoupAutoMappingConfiguration>())
            {
                using (ISession Session = Scope.OpenSession())
                {
                    ...
                    DataService ds = new DataService(ads, null, null, null, null, null, null, new UnitOfWork(Scope.GetSessionFactory()));
        ...
        public void IsFriendGenerateOkSQL_Success()
        {
            using (var Scope = new SQLiteDatabaseScope<PraLoupAutoMappingConfiguration>())
            {
                using (ISession Session = Scope.OpenSession())
                {
                    ...
                    DataService ds = new DataService(ads, null, null, null, null, cds, null, new UnitOfWork(Scope.GetSessionFactory()));
